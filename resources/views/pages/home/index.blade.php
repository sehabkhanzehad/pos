    ...
    <nav class="navbar sticky-top shadow-sm navbar-expand-lg navbar-light py-2">
        <div class="container">
            <a class="navbar-brand" href="#">
                <img class="img-fluid" src="{{ asset('assets/images/logo.png') }}" alt="" width="96px">
            </a>
        ...
        <div class="container pt-2">
            <div class="row align-items-center mb-5">
                ...
                <div class="col-12 col-lg-6 offset-lg-1">
                    <img class="img-fluid" src="{{ asset('assets/images/hero.svg') }}" alt="">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-3 p-3">
                    <div class="card px-0 text-center">
                        <img class=" card-img-top mb-3 w-100" src="{{ asset('assets/images/man.jpg') }}" alt="">
                        <h5>Danny Bailey</h5>
    ...
    <footer class="py-5 bg-light">
        <div class="container text-center pb-5 border-bottom">
            ...
            <div>
                ...
                <a class="d-inline-block me-4" href="#">
                    <img src="{{ asset('assets/images/github.svg') }}">
                </a>
                <a class="d-inline-block me-4" href="#">
